...
## Ekran görüntüleri
`AppStore/screenshots/` içindeki 5 PNG doğrudan yüklenir: iPhone 6.9" (1320×2868), başlıklı ve cihaz çerçeveli. App Store Connect 6.9" yüklendiğinde diğer iPhone boyutları için de kullanır.
