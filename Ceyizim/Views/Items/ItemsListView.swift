        ...
        NavigationStack {
            ...
            .confirmationDialog("Bu eşyayı silmek istediğine emin misin?",
                ...
                Button("Sil", role: .destructive) {
                    ...
                    Analytics.track("item_deleted", ["source": "list_swipe"])
                    itemToDelete = nil
                }
                        ...
                        .swipeActions(edge: .trailing, allowsFullSwipe: false) {
                            ...
                            if item.status != .gifted {
                                Button {
                                    ...
                                    Analytics.track("item_marked_gifted", ["source": "list_swipe"])
                                } label: {
                        ...
                        .swipeActions(edge: .leading, allowsFullSwipe: true) {
                            if item.status == .planned {
                                Button {
                                    ...
                                    Analytics.track("item_marked_purchased", ["source": "list_swipe"])
                                } label: {
                                ...
                                Button {
                                    ...
                                    Analytics.track("item_marked_planned", ["source": "list_swipe"])
                                } label: {
